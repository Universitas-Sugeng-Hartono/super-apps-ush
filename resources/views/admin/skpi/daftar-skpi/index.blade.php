                            ...
                            <div class="prereq-container">
                                <div class="prereq-badge done" 
                                     ...
                                     onclick="showDetailDataModal({{ json_encode([
                                        ...
                                        'lama_studi' => \App\Models\SkpiRegistration::calculateLamaStudi($s?->tanggal_masuk ? $s->tanggal_masuk->format('Y-m-d') : null, $reg->angkatan ?? $s?->angkatan, $reg->periode_lulus) ?? $reg->lama_studi,
