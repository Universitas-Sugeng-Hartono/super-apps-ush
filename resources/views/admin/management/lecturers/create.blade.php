...
@section('content')
    <div class="content-card">
        ...
        <form action="{{ route('admin.management.lecturers.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-card">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="password" class="form-control" placeholder="Kosongkan untuk password default: 12345678">
                    <small>Jika dikosongkan, password default adalah: 12345678</small>
