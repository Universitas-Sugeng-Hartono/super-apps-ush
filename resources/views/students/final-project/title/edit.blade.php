...
@section('content')
    <div class="stats-card">
        <div class="stats-header">
            <h3>Edit Judul Tugas Akhir</h3>
        </div>
        <p style="margin-top: 15px; color: #666; font-size: 14px;">
            Edit judul Tugas Akhir Anda. Judul akan kembali menunggu persetujuan admin.
        </p>
    </div>
    ...
    <form action="{{ route('student.final-project.title.update') }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="form-actions">
            ...
            <button type="submit" class="btn-primary">Update Judul</button>
        </div>
    </form>
@endsection
