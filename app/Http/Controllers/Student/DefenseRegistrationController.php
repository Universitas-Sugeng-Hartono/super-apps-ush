...
class DefenseRegistrationController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $request->validate([
            'final_draft_file'             => 'nullable|file|mimes:pdf,jpg,jpeg,png|max:2048',
            'ukt_semester_8_file'          => 'nullable|file|mimes:pdf,jpg,jpeg,png|max:2048',
            'bebas_perpustakaan_file'      => 'nullable|file|mimes:pdf,jpg,jpeg,png|max:2048',
            'persetujuan_dospem_file'      => 'nullable|file|mimes:pdf,jpg,jpeg,png|max:2048',
            'lembar_konsultasi_file'       => 'nullable|file|mimes:pdf,jpg,jpeg,png|max:2048',
